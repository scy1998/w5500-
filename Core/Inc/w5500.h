...
#define S1_RX_SIZE	2048	/*定义Socket接收缓冲区的大小，可以根据W5500_RMSR的设置修改 */
#define S1_TX_SIZE	2048  	/*定义Socket发送缓冲区的大小，可以根据W5500_TMSR的设置修改 */

//#define S2_RX_SIZE	1024	/*定义Socket接收缓冲区的大小，可以根据W5500_RMSR的设置修改 */
//#define S2_TX_SIZE	1024  	/*定义Socket发送缓冲区的大小，可以根据W5500_TMSR的设置修改 */

/***************----- W5500 GPIO定义 -----***************/
//#define W5500_SCS		GPIO_PIN_8	//定义W5500的CS引脚
//#define W5500_SCS_PORT	GPIOA
//
//#define W5500_RST		GPIO_PIN_12	//定义W5500的RST引脚
...
extern unsigned char S1_Port[2];	//端口0的端口号(5000) 
...
extern void SPI_WriteByte(uint8_t Send);
...
extern void W5500_GPIO_EXTI_Callback(uint16_t GPIO_Pin);
extern uint16_t W5500_Rec_Listen(void);
extern void W5500_Send_Data(unsigned char buffer[],uint16_t length);
extern uint8_t Rec_Flag;
uint16_t W5500_Rec_Listen_NO_INT(void);
extern void W5500_Socket1_Set(void);
void Socket0_Buffer_Empty(void);
unsigned char Read_W5500_1Byte(unsigned short reg);
void Write_W5500_SOCK_4Byte(SOCKET s, unsigned short reg, unsigned char *dat_ptr);
void Write_W5500_SOCK_2Byte(SOCKET s, unsigned short reg, unsigned short dat);
void Socket_DPort_Change(SOCKET s,int Dport);
void Socket_DIP_Change(SOCKET s,unsigned char *DIP);
